...
class InventivoAddSvgSupport
{
    public function __construct()
    {
        add_filter('upload_mimes', array($this, 'mime_types_svg'));
    ...
    public function mime_types_svg($mimes)
    {
                ...
                <div class="hreflang-x-default-tag-for-wpml-inventivo-wrapper">
                    <div class="hreflang-x-default-tag-for-wpml-inventivo-element">
                        <a href="https://www.inventivo.de/en/the-x-default-tag-in-wpml-is-missing-what-now#pluginkaufen" target="_blank">
                            <img src="' . plugins_url() . '/add-svg-support-for-media-uploader-inventivo/admin/images/icon-256x256-1.png" />
                        </a>
                    </div>
                    <div class="hreflang-x-default-tag-for-wpml-inventivo-element">
                        <h2>Hey Dude!</h2>
    ...
    {
        wp_enqueue_style('admin-styles', plugins_url().'/add-svg-support-for-media-uploader-inventivo/admin/css/admin-styles.css');
    }
...
if (is_admin()) {
    $inventivoAddSvgSupport = new InventivoAddSvgSupport();
}